CHERNAE-- -- 5. Find the average number of strikeouts per game by decade since 1920. Round the numbers you report to 2 decimal places. 
...
Strikeouts:
SELECT ROUND(AVG(teams.so/ batting.g), 2) as avg_strikeouts_per_game,  
...
Homeruns:
SELECT ROUND(AVG(batting.hr/ batting.g), 8) as avg_homeruns_per_game,  ----I moved the decimal place out to 8 because at 2 everything is 0.
		CASE WHEN yearid BETWEEN '1920' AND '1929' THEN '1920s'
	     WHEN yearid BETWEEN '1930' AND '1939' THEN '1930s' 
		 WHEN yearid BETWEEN '1940' AND '1949' THEN '1940s'
		 WHEN yearid BETWEEN '1950' AND '1959' THEN '1950s'
